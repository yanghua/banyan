...
@Exchanger(table = "SEND_PERMISSION", path = CONSTS.ZOOKEEPER_PATH_FOR_AUTH_SEND_PERMISSION)
public class SendPermissionZKExchanger extends AbstractExchanger {

    private static final Log logger = LogFactory.getLog(SendPermissionZKExchanger.class);

    public SendPermissionZKExchanger(LongLiveZookeeper zookeeper, String zkPath) {
