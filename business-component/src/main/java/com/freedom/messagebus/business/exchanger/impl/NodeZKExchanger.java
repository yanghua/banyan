...
@Exchanger(table = "NODE", path = CONSTS.ZOOKEEPER_ROOT_PATH_FOR_ROUTER)
public class NodeZKExchanger extends AbstractExchanger {

    private static final Log logger = LogFactory.getLog(NodeZKExchanger.class);

    public NodeZKExchanger(LongLiveZookeeper zookeeper, String zkPath) {
