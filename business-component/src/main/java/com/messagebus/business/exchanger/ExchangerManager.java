...
public class ExchangerManager {
    ...
    public void registerWithChannel(String clientId, IExchangerListener onChanged, String channel) {
    ...
    public void registerWithMultiChannels(String clientId, IExchangerListener onChanged, String[] channels) {
